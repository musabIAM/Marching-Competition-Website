...
Ajang Krease Lomba Baris Berbaris Terampil</div>
...
<br>
	...
	<div class="about-w3l" id="about">
		<div class="container">
			<h2 class="title-w3l"><span>Our Team</span></h2>
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/SMKN 1 CIMAHI.png" alt="">
				</div>
			</div>
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/Musab.png" alt="">
				</div>
				<div class="text-about ab-agile2">
					<h4>Musab <br> (Back End)</h4>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/RPL.png" alt="">
				</div>
			</div>
			...
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/alpi.png" alt="">
				</div>
				<div class="text-about ab-agile1">
					<h4>Alfiandika <br> (Front End) </h4>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/ajeng.png" alt="">
				</div>
				<div class="text-about ab-agile2">
					<h4>Ajeng <br> (Front End)</h4>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/deri.png" alt="">
				</div>
				<div class="text-about ab-agile3">
					<h4>Deri <br> (Desain)</h4>
				</div>
			</div>
			<div class="clearfix"> </div>
			...
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/multi.png" alt="">
				</div>
				<div class="text-about ab-agile1">
					<h4>Multiawan <br> (Front End) </h4>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/sasqia.png" alt="">
				</div>
				<div class="text-about ab-agile2">
					<h4>Sasqia <br> (Front End)</h4>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 col-news-top">
				<div class="date-in">
					<img class="img-responsive mix-in" src="images/wening.png" alt="">
				</div>
				<div class="text-about ab-agile3">
					<h4>Wening <br> (Back End)</h4>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
	...
	<div class="w3layouts_copy_right">
		<div class="container">
			<p>Akrobat 2017 | Dari Sumpah Pemuda | Hingga Aksi Pemuda</p>
		</div>
	</div>
	<!-- //copyright -->
