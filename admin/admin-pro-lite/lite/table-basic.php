<?php  
include "conec.php";
$result = mysql_query("SELECT *FROM akun");
 ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Akun yang ada</h4>
                                    ...
                                    <table class="table">
                                        ...
                                        <?php 
                                            while ($row=mysql_fetch_array($result)) {
                                                    ...
                                                    echo "<td>
                                                    <a href=pages-profile.php?id=".$row['id_user'].">Edit</a>
                                                    <a href=delet.php?id=".$row['id_user'].">Delete</a>
                                                    </td>";
                                                    echo "</tr>";
                                                }
                                           ?>                                                    
