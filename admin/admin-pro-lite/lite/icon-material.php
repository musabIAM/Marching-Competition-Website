...
<body class="fix-header card-no-border fix-sidebar">
    ...
    <div id="main-wrapper">
        ...
        <!-- ============================================================== -->
         <header class="topbar" style="height: 83px;">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            <div style="padding-top: 18%; padding-right: 35%;" class="container" style="">
  
                             <div class="dropdown">
                                <button class="btn dropdown-toggle" type="button" data-toggle="dropdown" style="border-radius: 100%; background-color: transparent;"><i style="font-size: 30px;" class="mdi mdi-account-circle"></i>
                                <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                     <li class="dropdown-header" style="font-size: 14px;">Settings</li>
                                     <li><a class="nav-link waves-effect waves-dark" href="#" href="#">Username</a></li>
                                     <li><a class="nav-link waves-effect waves-dark" href="#" href="#">Status</a></li>
                                     <li class="divider"></li>
                                     <li class="dropdown-header">Dropdown header 2</li>
                                     <li><a class="nav-link waves-effect waves-dark" href="#" href="#">Log Out</a></li>
                                     </ul>
                                 </div>
                                 </div>
