...
<br>
	...
	<div class="about-w3l" id="about">
		<div class="container">
			<h2 class="title-w3l"> <span> Contact </span></h2><center>
			<div class="col-lg-6 col-md-6 col-sm-6">
				<img class="welkom img-responsive" src="images/tampilan.png">
			</div>
			...
			<div class="col-lg-5 col-md-5 col-sm-5">
				...
				<form action="proseskontak.php" method="post">
					<div class="form-group">
						<input required="required" type="text" class="form-control setform" placeholder="Your Name" name="nama">
					</div>
					<div class="form-group">
						<input required="required" type="text" class="form-control setform" placeholder="Email" name="email">
					</div>
					<div class="form-group">
						<textarea required="required" class="form-control setform" placeholder="Your Message" name="pesan" rows="5"></textarea>
					</div>
					<div class="form-group">
						<input type="submit" value="Kirim" class="btn btn-danger setsubmit">
					</div>
				</form>
			<div>
			<font face="comic sans ms" size="15"></font></center>
